...
//boolean Network::bindSocket(struct sockaddr_in *server, SOCKET *s) {
//	//Bind
...
//boolean Network::listenforConnections(SOCKET *s, int maxConQueue)
//{
...
//	if (acceptConnection(s, newSocket, client) == 1) {
//		return 1;
//	}
//	return 0;
//}
...
boolean Network::connectToServer(SOCKET *s, struct sockaddr_in *server)
{
...
//boolean Network::receive(SOCKET *s, char* receivedMessage, int buffSize)
//{
//	int recv_size;
//
...
boolean Network::getIPFromDomain(char* hostName, PWSTR ip)
{
...
//}
//
//boolean Network::getSockAddrInfo(char *ip, int *port, struct sockaddr_in *sockAddr, int family)
//{
//	puts("\nInfo:");
